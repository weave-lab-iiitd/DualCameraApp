...
public class SampleApplicationSession implements UpdateCallbackInterface
{
   ...
   // private int mCamera =CAMERA_DIRECTION_FRONT;
    ...
    public void initAR(Activity activity, int screenOrientation)
    {
        ...
        Log.d(LOGTAG,"The value of the mVuforiaFlag in the Front Camera SampleApplicationSession is given as:"+mVuforiaFlags);
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            synchronized (mLifecycleLock)
            {
                Vuforia.setInitParameters(mActivity, mVuforiaFlags, "");
