...
import com.vuforia.samples.SampleTest.utils.VideoBackgroundShader;
import com.vuforia.samples.SampleTest.utils.SampleUtils;
import xyz.example.com.frontcameravuforiaapp.VuforiaSamples.app.ImageTargets.FrontCamera;
...
public class SampleAppRenderer {
    ...
    private FrontCamera mActivity = null;
    ...
    public SampleAppRenderer(SampleAppRendererControl renderingInterface, FrontCamera activity, int deviceMode,
    ...
    private void storeScreenDimensions()
    {
        ...
        (mActivity.getActivity()).getWindowManager().getDefaultDisplay().getRealSize(size);
        mScreenWidth = size.x;
